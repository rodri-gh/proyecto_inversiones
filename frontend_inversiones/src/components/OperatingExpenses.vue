        ...
        <div class="table-responsive">
          <table class="table">
            ...
            <tbody>
              ...
              <tr
                v-for="operatingExpense in operatingExpenses"
              ...
              >
                ...
                <td>
                  <span
                    v-if="operatingExpense.deleted == 1"
                ...
                <td>
                  ...
                  <button
                    ...
                    @click="deleteOperatingExpense(operatingExpense.id)"
                  >
                    <i class="fa fa-trash"></i>
                  </button>
                  <button
                    v-if="operatingExpense.deleted == 0"
      ...
      >
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="modalTitleId">Operating Expenses</h5>
            <button
              type="button"
              class="btn-close"
          ...
          <div class="modal-footer">
            ...
            <button
              v-if="
                selectedOperatingExpense && selectedOperatingExpense.id == null
              "
              type="button"
              class="btn btn-primary"
              @click="createOperatingExpense()"
            >
              Save
            </button>
            <button
