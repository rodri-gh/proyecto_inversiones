        ...
        <div class="tab-pane fade show active" id="all" role="tabpanel" aria-labelledby="all-tab">
          <div class="row pt-3">
            <div class="mb-3 col-md-6">
              ...
              <input type="text" class="form-control" id="name" :value="userProfile.name" readonly />
            </div>
            <div class="mb-3 col-md-6">
              <label for="lastName" class="form-label">Apellidos</label>
              <input type="text" class="form-control" id="lastName" :value="userProfile.lastName" readonly />
            </div>
            <div class="mb-3 col-md-6">
            ...
            <div class="mb-3 col-md-6">
              <label for="documentNumber" class="form-label">Nro. de Documento</label>
              <input type="text" class="form-control" id="documentNumber" :value="userProfile.documentNumber"
                readonly />
            </div>
            <div class="mb-3 col-md-6">
              <label for="phone" class="form-label">Teléfono</label>
              <input type="phone" class="form-control" id="phone" :value="newPhone" readonly />
            </div>
          </div>
        </div>
        <div class="tab-pane fade" id="active" role="tabpanel" aria-labelledby="active-tab">
          <div class="row pt-3">
            <div class="mb-3 col-md-12">
              <button class="btn btn-primary mt-2" data-bs-toggle="modal" data-bs-target="#passwordModal">
                Cambiar contraseña
              </button>
            </div>
            <div class="mb-3 col-md-6">
              <label for="newPhone" class="form-label">Teléfono</label>
              <input type="phone" class="form-control" id="newPhone" :value="newPhone" readonly />
            </div>
            <div class="mb-3 col-md-12">
              <button class="btn btn-primary mt-2" data-bs-toggle="modal" data-bs-target="#phoneModal">
                Cambiar teléfono
              </button>
            </div>
          </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="mb-3">
                ...
                <input type="phone" class="form-control" id="tempPhone" v-model="tempPhone" />
              </div>
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">
