  ...
  <div class="row col-md-5 col-sm-12 mx-auto card shadow border-0 py-5 px-5">
    <div class="card-body">
      <div class="mb-3 col-md-12">
        <label for="name" class="form-label">Nombres <span class="text-danger">*</span>
        </label>
        <input type="text" class="form-control" name="nombres" id="nombres" placeholder="Ingresa tu nombre" />
        <label for="nombres" class="form-label">Apellidos <span class="text-danger">*</span>
        </label>
        <input type="text" class="form-control" name="nombres" id="nombres" placeholder="Ingresa tu nombre" />
      </div>
      <div class="mb-3 col-md-12">
