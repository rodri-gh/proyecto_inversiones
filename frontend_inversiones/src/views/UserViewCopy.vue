            ...
            <table class="table">
              ...
              <tbody>
                ...
                <tr v-for="user in users" :key="user.id">
                  ...
                  <td>{{ user.phone }}</td>
                  <td>
                    <span v-if="user.deleted == 1" class="badge bg-success"
                      >Activo</span
                    >
            ...
            <div class="modal-body px-5">
              <div class="mb-3 col-md-12">
                ...
                <label for="username" class="form-label mt-3"
                  >Nombre de Ususario <span class="text-danger">*</span></label
                >
                <input
                  type="text"
                  class="form-control"
                ...
                <label for="role" class="form-label mt-3"
                  >Rol de Usuario de Ususario <span class="text-danger">*</span></label
                >
                <select
                  type="text"
                  class="form-control"
                ...
                <label for="confirmPassword" class="form-label mt-3"
                  >Repita su contraseña <span class="text-danger">*</span></label
                >
                <input
              ...
              <div class="modal-footer">
                ...
                <button
                  v-if="selectedUser && selectedUser.id == null"
                  type="button"
                  @click="createUser()"
                  class="btn btn-primary"
                >
